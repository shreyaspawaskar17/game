...
import p1.StageCatalogue;
import p1.StageCatalogue.submitHandler;
public class gameZoneB1 extends JPanel{
    ...
    private static int LEV_SEC = 180; // in pixels
    ...
    private static int HIT_TARGET = 1;
    ...
    private double performance1 = 0.0;
    ...
    public static void main(String[] args) {
		...
		StageCatalogue sg = new StageCatalogue();
		StageCatalogue.submitHandler sh = sg.new submitHandler();
		 System.out.println(sh.name1);
    ...
    public double getPerformance() {
        if (Y > 0) {
            performance1 = (double) totalTime / Y;
	...
	public gameZoneB1() {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if((phone.min == 0 && phone.sec == 0) || hitCount == HIT_TARGET ||   (Max_MISSES - missCount  == 0) ) {
            	...
            	popup();
            	  int remainingTime = phone.min * 60 + phone.sec;
            	    totalTime = LEV_MIN * 60 + LEV_SEC - remainingTime;
