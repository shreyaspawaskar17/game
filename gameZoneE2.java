...
public class gameZoneE2 extends JPanel{
    ...
    private double performance6 = 0.0;
    ...
    public static void main(String[] args) {
    	//Setting up Font 
		try {
			InputStream font = gameZoneE2.class.getResourceAsStream("/Font/PixelMplus10-Regular.ttf");//Imports the font file
		...
		gameZoneE2 gamePanel = new  gameZoneE2();
		...
		Image img1 = new ImageIcon(gameZoneE2.class.getResource("/Images/pause.png")).getImage(); // removed that .getClass part from the previous buttons
	...
	phone.timedisplayer.setForeground(Color.yellow);
		...
		while (true) { // Continuously repaint the panel with a delay of 1 second
			...
			gamePanel.fimgPositionX = 0;
			gamePanel.fimgPositionY = 0;
			gamePanel.bimgPositionX = 0;
			gamePanel.bimgPositionY = 0;
			gamePanel.repaint();
    ...
    public double getPerformance() {
        if (Y > 0) {
            performance6 = (double) totalTime / Y;
        }
        return performance6;
    }
    ...
    public gameZoneE2() {
        ...
        public static class pauseResumeHandler implements ActionListener{
    		...
    		public void actionPerformed(ActionEvent e) {
    			Image img2 = new ImageIcon(gameZoneE2.class.getResource("/Images/play.png")).getImage();  // removed that .getClass part from the previous buttons
    			...
    			Image img1 = new ImageIcon(gameZoneE2.class.getResource("/Images/pause.png")).getImage();;
    			pauseResumeButton.setIcon(new ImageIcon(img1 ));
    			flag3 = true;
