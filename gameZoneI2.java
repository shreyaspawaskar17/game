...
public class gameZoneI2 extends JPanel{
    ...
    private static int LEV_SEC = 0; // in pixels
    ...
    private static int HIT_TARGET = 35;
    ...
    private double performance4 = 0.0;
    ...
    public static void main(String[] args) {
    	//Setting up Font 
		try {
			InputStream font = gameZoneI2.class.getResourceAsStream("/Font/PixelMplus10-Regular.ttf");//Imports the font file
		...
		Image img1 = new ImageIcon( gameZoneI2.class.getResource("/Images/pause.png")).getImage(); // removed that .getClass part from the previous buttons
    ...
    public double getPerformance() {
        if (Y > 0) {
            performance4 = (double) totalTime / Y;
        }
        return performance4;
    }
    ...
    public gameZoneI2() {
        ...
        public static class pauseResumeHandler implements ActionListener{
    		...
    		public void actionPerformed(ActionEvent e) {
    			Image img2 = new ImageIcon(gameZoneI2.class.getResource("/Images/play.png")).getImage();  // removed that .getClass part from the previous buttons
    			...
    			Image img1 = new ImageIcon(gameZoneI2.class.getResource("/Images/pause.png")).getImage();;
    			pauseResumeButton.setIcon(new ImageIcon(img1 ));
    			flag3 = true;
